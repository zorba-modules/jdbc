 ...
 */
#pragma once
#ifndef ZORBA_JDBC_MODULE_CLOSEPREPARED_H
#define ZORBA_JDBC_MODULE_CLOSEPREPARED_H
...
namespace zorba {
  namespace jdbc {
    ...
    public:
      ...
      virtual String getLocalName() const { return "close-prepared"; }
...
#endif //ZORBA_JDBC_MODULE_CLOSEPREPARED_H
