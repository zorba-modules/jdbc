 ...
 */
#pragma once
#ifndef ZORBA_JDBC_MODULE_CLEARPARAMS_H
#define ZORBA_JDBC_MODULE_CLEARPARAMS_H
...
namespace zorba {
  namespace jdbc {
    ...
    public:
      ...
      virtual String getLocalName() const { return "clear-params"; }
...
#endif //ZORBA_JDBC_MODULE_CLEARPARAMS_H
