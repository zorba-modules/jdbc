 ...
 */
#pragma once
#ifndef ZORBA_JDBC_MODULE_EXECUTEQUERYDETERMINISTIC_H
#define ZORBA_JDBC_MODULE_EXECUTEQUERYDETERMINISTIC_H
...
namespace zorba {
  namespace jdbc {
    ...
    public:
      ...
      virtual String getLocalName() const { return "execute-query-deterministic"; }
...
#endif //ZORBA_JDBC_MODULE_EXECUTEQUERYDETERMINISTIC_H
