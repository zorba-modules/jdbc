 ...
 */
#pragma once
#ifndef ZORBA_JDBC_MODULE_ISCONNECTED_H
#define ZORBA_JDBC_MODULE_ISCONNECTED_H
...
namespace zorba {
  namespace jdbc {
    ...
    public:
      ...
      virtual String getLocalName() const { return "is-connected"; }
...
#endif //ZORBA_JDBC_MODULE_ISCONNECTED_H
