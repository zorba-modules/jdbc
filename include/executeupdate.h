 ...
 */
#pragma once
#ifndef ZORBA_JDBC_MODULE_EXECUTEUPDATE_H
#define ZORBA_JDBC_MODULE_EXECUTEUPDATE_H
...
namespace zorba {
  namespace jdbc {
    ...
    public:
      ...
      virtual String getLocalName() const { return "execute-update"; }
...
#endif //ZORBA_JDBC_MODULE_EXECUTEUPDATE_H
