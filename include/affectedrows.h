 ...
 */
#pragma once
#ifndef ZORBA_JDBC_MODULE_AFFECTEDROWS_H
#define ZORBA_JDBC_MODULE_AFFECTEDROWS_H
...
namespace zorba {
  namespace jdbc {
    ...
    public:
      ...
      virtual String getLocalName() const { return "affected-rows"; }
...
#endif //ZORBA_JDBC_MODULE_DISCONNECT_H
