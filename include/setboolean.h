 ...
 */
#pragma once
#ifndef ZORBA_JDBC_MODULE_SETBOOLEAN_H
#define ZORBA_JDBC_MODULE_SETBOOLEAN_H
...
namespace zorba {
  namespace jdbc {
    ...
    public:
      ...
      virtual String getLocalName() const { return "set-boolean"; }
...
#endif //ZORBA_JDBC_MODULE_SETBOOLEAN_H