 ...
 */
#pragma once
#ifndef ZORBA_JDBC_MODULE_SETVALUE_H
#define ZORBA_JDBC_MODULE_SETVALUE_H
...
namespace zorba {
  namespace jdbc {
    ...
    public:
      ...
      virtual String getLocalName() const { return "set-value"; }
...
#endif //ZORBA_JDBC_MODULE_SETVALUE_H