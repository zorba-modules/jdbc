 ...
 */
#pragma once
#ifndef ZORBA_JDBC_MODULE_SETSTRING_H
#define ZORBA_JDBC_MODULE_SETSTRING_H
...
namespace zorba {
  namespace jdbc {
    ...
    public:
      ...
      virtual String getLocalName() const { return "set-string"; }
...
#endif //ZORBA_JDBC_MODULE_SETSTRING_H