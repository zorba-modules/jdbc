 ...
 */
#pragma once
#ifndef ZORBA_JDBC_MODULE_PARAMETERMETADATA_H
#define ZORBA_JDBC_MODULE_PARAMETERMETADATA_H
...
namespace zorba {
  namespace jdbc {
    ...
    public:
      ...
      virtual String getLocalName() const { return "parameter-metadata"; }
...
#endif //ZORBA_JDBC_MODULE_PARAMETERMETADATA_H