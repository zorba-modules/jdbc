 ...
 */
#pragma once
#ifndef ZORBA_JDBC_MODULE_RESULTSET_H
#define ZORBA_JDBC_MODULE_RESULTSET_H
...
namespace zorba {
  namespace jdbc {
    ...
    public:
      ...
      virtual String getLocalName() const { return "result-set"; }
...
#endif //ZORBA_JDBC_MODULE_RESULTSET_H