 ...
 */
#pragma once
#ifndef ZORBA_JDBC_MODULE_METADATA_H
#define ZORBA_JDBC_MODULE_METADATA_H
...
namespace zorba {
  namespace jdbc {
    ...
    public:
      ...
      virtual String getLocalName() const { return "metadata"; }
...
#endif //ZORBA_JDBC_MODULE_METADATA_H
