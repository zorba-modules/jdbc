 ...
 */
#pragma once
#ifndef ZORBA_JDBC_MODULE_CONNECT_H
#define ZORBA_JDBC_MODULE_CONNECT_H
...
namespace zorba {
  namespace jdbc {
    ...
    public:
      ...
      virtual String getLocalName() const { return "connect"; }
    ...
    public:
      virtual String getLocalName() const { return "connect-nondeterministic"; }
    };
...
#endif //ZORBA_JDBC_MODULE_CONNECT_H
