 ...
 */
#pragma once
#ifndef ZORBA_JDBC_MODULE_SETNULL_H
#define ZORBA_JDBC_MODULE_SETNULL_H
...
namespace zorba {
  namespace jdbc {
    ...
    public:
      ...
      virtual String getLocalName() const { return "set-null"; }
...
#endif //ZORBA_JDBC_MODULE_SETNULL_H