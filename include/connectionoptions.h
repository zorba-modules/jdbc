 ...
 */
#pragma once
#ifndef ZORBA_JDBC_MODULE_CONNECTOPTIONS_H
#define ZORBA_JDBC_MODULE_CONNECTOPTIONS_H
...
namespace zorba {
  namespace jdbc {
    ...
    public:
      ...
      virtual String getLocalName() const { return "connection-options"; }
...
#endif //ZORBA_JDBC_MODULE_CONNECTOPTIONS_H
